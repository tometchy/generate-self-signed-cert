...
openssl req -x509 -new -key /out/${DOMAIN}_private.pem -out /out/${DOMAIN}_public.pem -passout pass:${PASSWORD} -subj "/C=GB/ST=Nottingham/L=Nottinghamshire/O=${ORGANIZATION}/OU=IT/CN=${DOMAIN}/emailAddress=tometchy@gmail.com"
