...
openssl req -x509 -new -key /out/${DOMAIN}_private.pem -out /out/${DOMAIN}_public.pem -passout pass:${PASSWORD} -subj "/C=${C}/ST=${ST}/L=${L}/O=${O}/OU=IT/CN=${DOMAIN}/emailAddress=tometchy@gmail.com"
